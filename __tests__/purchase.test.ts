...
test('purchase form', async done => {
    ...
    expect(t0.elements![0]).toMatchObject({accountId: 506, amount: 1000, currency: 'USD', useGross: 0, description: 'one'})
    expect(t0.elements![1]).toMatchObject({accountId: 507, amount: 10000, currency: 'USD', useGross: 1, description: 'two'})
...
test('purchase form with reverse charge', async done => {
    ...
    expect(t0.elements![0]).toMatchObject({accountId: 506, amount: 10000, currency: 'USD', useGross: 0, description: 'one'})
