...
test('sale form', async done => {
    ...
    expect(t0.elements![3]).toMatchObject({accountId: TaxPayable, amount: 0, currency: 'USD', taxCode: ':zero:0', parentId: t0.elements![0].id})
    expect(t0.elements![4]).toMatchObject({accountId: TaxPayable, amount: 100, currency: 'USD', taxCode: '::10', parentId: t0.elements![0].id})
    expect(t0.elements![5]).toMatchObject({accountId: TaxPayable, amount: 1000, currency: 'USD', taxCode: '::10', parentId: t0.elements![1].id})
    expect(t0.elements![6]).toMatchObject({accountId: TaxPayable, amount: 1000, currency: 'USD', taxCode: '::10', parentId: t0.elements![1].id})
